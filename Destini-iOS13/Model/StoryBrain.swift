...
struct StoryBrain {
    ...
    func getStory(storyNumber: Int) -> String {
...
//            nextStory = stories[nextStory].choice1Destination
//        }
//        else if userChoice == stories[nextStory].choice2{
//            nextStory = stories[nextStory].choice2Destination
//        }
//        return nextStory
    }
